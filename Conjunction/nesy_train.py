...
parser.add_argument('--b', default=1, type=float, help='the pre-defined value of b')
...
#### training
file_name = 'conj' + '_' + str(opt.len) + '_' + opt.exp_name + '_zero'
save_logic(phi0, file_name)
# learn clause of b = opt.len
file_name = 'conj' + '_' + str(opt.len) + '_' + opt.exp_name + '_' + str(opt.b)
phi = train(X_train, 1-y_train, opt)
