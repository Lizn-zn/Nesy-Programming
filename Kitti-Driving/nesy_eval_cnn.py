...
# loading
ckpt = './checkpoint/net_0_logic_clauses_3000__0.t7'
# ckpt = './checkpoint/net_0_logic_clauses_10000_lamda=1e-5_alpha=1e5__0.t7' 
# init chektpoint
...
#     tmp = []
#     for i in range(100):
#         tmp.append(W[i*100+k,0:100].reshape(1,-1))
#     print(torch.linalg.matrix_rank(torch.cat(tmp, dim=0)))
W, b, bmin, bmax = bounding_box(net, phi, train_dataloader)
print(W.shape)
bmin = bmax
evaluate_batch_cnn(net, W, b, bmin, bmax, test_dataloader, threshold=0.5)
