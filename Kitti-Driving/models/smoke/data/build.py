...
from .collate_batch import BatchCollator, KeypointsOnlyBatchCollator
...
def make_data_loader(cfg, is_train=True):
    ...
    for dataset in datasets:
        ...
        if hasattr(dataset, 'planning'):
            collator = KeypointsOnlyBatchCollator(cfg.DATALOADER.SIZE_DIVISIBILITY)
        else:
