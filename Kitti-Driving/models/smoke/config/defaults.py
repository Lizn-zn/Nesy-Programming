...
_C.MODEL.WEIGHT = ""
## append attribute "model.only_keypoints" to use the SMOKEKeypointsOnlyHead constructed by ourselves
_C.MODEL.KEYPOINTS_ONLY = True
_C.MODEL.BINARY_CLASSIFICATION = True
...
_C.INPUT.SHIFT_SCALE_PROB_TRAIN = 0.0
_C.INPUT.SHIFT_SCALE_TRAIN = (0.2, 0.4)

_C.INPUT.FEATURE_WIDTH = 1280
_C.INPUT.FEATURE_HEIGHT = 384
...
_C.NUSCENSES_INPUT = CN()
# Size of the smallest side of the image during training
_C.NUSCENSES_INPUT.HEIGHT_TRAIN = 896
# Maximum size of the side of the image during training
_C.NUSCENSES_INPUT.WIDTH_TRAIN = 1600
# Size of the smallest side of the image during testing
_C.NUSCENSES_INPUT.HEIGHT_TEST = 896
# Maximum size of the side of the image during testing
_C.NUSCENSES_INPUT.WIDTH_TEST = 1600
# Values to be used for image normalization
_C.NUSCENSES_INPUT.PIXEL_MEAN = [0.485, 0.456, 0.406]  # kitti
# Values to be used for image normalization
_C.NUSCENSES_INPUT.PIXEL_STD = [0.229, 0.224, 0.225]  # kitti
# Convert image to BGR format
_C.NUSCENSES_INPUT.TO_BGR = True
# Flip probability
_C.NUSCENSES_INPUT.FLIP_PROB_TRAIN = 0.0
# Shift and scale probability
_C.NUSCENSES_INPUT.SHIFT_SCALE_PROB_TRAIN = 0.0
_C.NUSCENSES_INPUT.SHIFT_SCALE_TRAIN = (0.2, 0.4)
...
_C.NESY_DATASETS = CN()
_C.NESY_DATASETS.DETECT_CLASSES = ("Car", "Pedestrian", "Cyclist")
_C.NESY_DATASETS.MAX_OBJECTS = 30
_C.NESY_DATASETS.USE_REAL_TARGETS = True
_C.NESY_DATASETS.USE_GROUNDTRUTH_GRIDS_FOR_TARGETS = True
...
# --------------------------SMOKE Keypoints-Only Head--------------------------
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD = CN()
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.PREDICTOR = "SMOKEKeypointsOnlyPredictor"
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.LOSS_TYPE = ("FocalLoss", "DisL1")
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.LOSS_ALPHA = 2
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.LOSS_BETA = 4
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.LOSS_WEIGHT = (1., 2.5)
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.CLASSIFICATION_HEADS = 1
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.REGRESSION_HEADS = 3
# Specific channel for (depth_offset, keypoint_offset)
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.REGRESSION_CHANNEL = (1, 2,)
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.USE_NORMALIZATION = "GN"
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.NUM_CHANNEL = 256
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.DIMENSION_REFERENCE = ((3.88, 1.63, 1.53),
                                           (1.78, 1.70, 0.58),
                                           (0.88, 1.73, 0.67))
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.DEPTH_REFERENCE = (28.01, 16.32)
_C.MODEL.SMOKE_KEYPOINTS_ONLY_HEAD.USE_NMS = False
...
_C.OUTPUT_DIR = "./data/kitti-smoke/logs"
