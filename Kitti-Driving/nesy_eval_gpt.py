...
from dataset import build_dataset_kitti
...
ckpt = './checkpoint/final_model_0.t7'
# init chektpoint
...
def bounding_box(net, phi, dataloader):
    ...
    for batch_idx, sample in enumerate(dataloader):
        ...
        # out = torch.cat([symbol, y], dim=-1)
        Z[index,:] = torch.cat([symbol, y], dim=-1)
...
evaluate_batch_gpt(net, W, b, bmin, bmax, test_dataloader, threshold=0.5)
