...
parser.add_argument('--num_iters', default=3000, type=int, help='the number of iters to increase t')
parser.add_argument('--logic_lr', default=50000.0, type=float, help='the step size of programming')
