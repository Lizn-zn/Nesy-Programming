...
parser.add_argument('--num_iters', default=1000, type=int, help='the number of iters to increase t')
parser.add_argument('--logic_lr', default=100000.0, type=float, help='the step size of programming')
